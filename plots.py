...
# just to test the plots, change them to the actual data
csv_list = [("./data/monte_carlo_branch=200_ngames=5_method=2.csv", "branches_200_games_5", 200),
            ...
            ("./data/monte_carlo_branch=1_ngames=200_method=2.csv", "branches_1_games_200", 1),
